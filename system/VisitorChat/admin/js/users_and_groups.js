$(document).ready(function(){
    ...
    var OptionsTimeout;
			...
			$(".g_options").click(function(){
				...
				$(".g_main").append('<div class="user_options" style="position:fixed; left:'+(position.right+240)+'px; top:'+(obj_pos.top+141)+'px;"><a href="index.php?page=groupedit&id='+c_this.attr('rel')+'">Edit group</a><a href="index.php?page=groupdelete&id='+c_this.attr('rel')+'">Delete group</a></div>');
			...
			$(".u_options").click(function(){
				...
				$(".users").append('<div class="user_options" style="position:fixed; left:'+(position.right+240)+'px; top:'+(obj_pos.top+141)+'px;"><a href="index.php?page=useredit&id='+c_this.attr('rel')+'">Edit user</a><a href="index.php?page=userdelete&id='+c_this.attr('rel')+'">Delete user</a></div>');

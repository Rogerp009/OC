<form action="" method="post" name="users_az" target="_self" class="htmlForm">
  ...
  <div class="gridView">
    <table id="users_az" cellpadding="0" cellspacing="0" border="0">
      ...
      <tbody>
        <?php require_once(ROOT_PATH.'admin/modules/users_az/users_az.php'); ?>
        <!-- msg --> 
        <?php echo $msg; ?>
      <tbody>
    </table>
  ...
  <div class="gvActionsWrap"> 
    ...
    <select name="jumpMenu" id="jumpMenu" onchange="MM_jumpMenu('parent',this,0)" class="jumpMenu">
      <option value="users-a-z.php">Mostrar</option>
      <option value="users-a-z.php?display=1">1</option>
      <option value="users-a-z.php?display=5">5</option>
      <option value="users-a-z.php?display=10">10</option>
      <option value="users-a-z.php?display=15">15</option>
      <option value="users-a-z.php?display=20">20</option>
      <option value="users-a-z.php?display=25">25</option>
      <option value="users-a-z.php?display=50">50</option>
      <option value="users-a-z.php?display=100">100</option>
      <option value="users-a-z.php?display=1000">1000</option>
    </select>
    <!-- include paging interface -->
    <?php require_once(ROOT_PATH.'admin/modules/users_az/users_az.paging.php'); ?>

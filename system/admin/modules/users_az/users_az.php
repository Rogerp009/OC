...
// ------------------------------------------------------------
$query1 = "SELECT UserId, UserName, Email, IsApproved, IsLockedOut, IsLoggedIn, CreateDate FROM $tableName WHERE UserName LIKE '$az_letter%' ORDER BY $default_sorting LIMIT $start, $limit";
...
while($row = mysqli_fetch_array($result))
{
	...
	'<td id="column2" title="Click aqui para editar"><a href="user-details.php?uid='.$user_id.'" class="arrow_icon modal">'.$user_name.'</a></td>'.

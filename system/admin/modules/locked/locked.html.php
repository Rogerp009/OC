<form action="" method="post" name="users_locked" target="_self" class="htmlForm">
  <!-- gridview -->
  <div class="gridView">
    <table id="users_az" cellpadding="0" cellspacing="0" border="0">
      ...
      <tbody>
        <?php require_once(ROOT_PATH.'admin/modules/locked/locked.php'); ?>
        <!-- msg --> 
        <?php echo $msg; ?>
      <tbody>
    </table>
  ...
  <div class="gvActionsWrap"> 
    ...
    <select name="jumpMenu" id="jumpMenu" onchange="MM_jumpMenu('parent',this,0)" class="jumpMenu">
      <option value="locked-users.php">display</option>
      <option value="locked-users.php?display=1">1</option>
      <option value="locked-users.php?display=5">5</option>
      <option value="locked-users.php?display=10">10</option>
      <option value="locked-users.php?display=15">15</option>
      <option value="locked-users.php?display=20">20</option>
      <option value="locked-users.php?display=25">25</option>
      <option value="locked-users.php?display=50">50</option>
      <option value="locked-users.php?display=100">100</option>
      <option value="locked-users.php?display=1000">1000</option>
    </select>
    <!-- include paging interface -->
    <?php require_once(ROOT_PATH.'admin/modules/locked/locked.paging.php'); ?>
